            ...
            <div class="w-full lg:w-1/2">
                ...
                <div class="w-full lg:w-1/2 order-first lg:order-last">
                    <div class="about-img-2 relative z-10 pt-19 pb-19 mb-18 lg:mb-0">
                        <img src="{{ asset('assets/img/about/about-2.png') }}" alt="" class="w-100">
                        <img src="{{ asset('assets/img/about/about-right-shape.svg') }}" alt=""
                            class="shape shape-1">
                        <img src="{{ asset('assets/img/about/right-dots.svg') }}" alt="" class="shape shape-2">
                    </div>
                </div>
            </div>
        </div>
