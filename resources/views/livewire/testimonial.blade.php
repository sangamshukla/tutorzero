<section id="testimonials" class="testimonial-section pt-8 pb-25 sm:p-0 lg:py-170">
    <div class="container">
        ...
        <div class="testimonial-active-wrapper relative">
            ...
            <div class="shapes">
                <img src="{{ asset('assets/img/testimonial/testimonial-shape.svg') }}" alt=""
                    class="shape shape-1 hidden lg:block -left-25 top-1/2 transform -translate-y-1/2">
                <img src="{{ asset('assets/img/testimonial/testimonial-dots.svg') }}" alt=""
                    ...
                    <div class="row flex">
                        <div class="w-full lg:w-5/12">
                            <div
                                ...
                                <img src="{{ asset('assets/img/testimonial/testimonial-1.png') }}" alt=""
                                    class="lg:ml-auto">
                                <div class="quote">
                ...
                <div class="single-testimonial">
                    <div class="row flex">
                        <div class="w-full lg:w-5/12">
                            <div
                                class="testimonial-img inline-block lg:block text-left lg:text-right relative mb-8 lg:mb-0">
                                <img src="{{ asset('assets/img/testimonial/testimonial-2.png') }}" alt=""
                                    class="lg:ml-auto">
                                <div class="quote">
                                    <i class="lni lni-quotation"></i>
                                </div>
